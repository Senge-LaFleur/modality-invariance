#!/bin/bash
#SBATCH --job-name=train_Modality_Invariance_resnet18
...
SCRIPT_NAME="../train_Modality_Invariance_resnet18.py"       

export DATA_ROOT="$WORK_DIR/data/datasets"

export WORK_ROOT="$WORK_DIR/outputs_Modality_Invariance_resnet18"
