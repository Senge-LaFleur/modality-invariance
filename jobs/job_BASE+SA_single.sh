#!/bin/bash
#SBATCH --job-name=train_BASE+SA+_single
...
# ablation:
#   sbatch "job_BASE+SA+_single.sh" clinical
#   sbatch "job_BASE+SA+_single.sh" derm
...
OUTPUT_DIR="outputs_BASE+SA+_single_${TRAIN_MODALITY}"

SCRIPT_NAME="../train_BASE+SA+_single.py"
