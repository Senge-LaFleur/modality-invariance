...
IMAGE_ROOTS = {
    ...
    'padufes20':      Path('process_No_MI_vit/data/datasets/mahdavi1202/skin-cancer'),
    'isic2019':       Path('process_No_MI_vit/data/datasets/sengenjih/isic2019'),
}
...
def main():
    ...
    plot_training_curves(history, "Training History (No_MI ViT)",
