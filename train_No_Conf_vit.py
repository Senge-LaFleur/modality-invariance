...
Uses multi-objective losses: Lcls, Lcon, LMI. (No L_conf, L_skin)
...
# Local ViT layer-wise LR helper
...
IMAGE_ROOTS = {
    'hiba':           Path('process_No_Conf_vit/data/datasets/asosenge/hibaskinlesionsdataset-main/HIBASkinLesionsDataset-main/images'),
    'fitzpatrick17k': Path('process_No_Conf_vit/data/datasets/asosenge/fitzpatrick17k/fitzpatrick17k/data/finalfitz17k'),
    'derm7pt':        Path('process_No_Conf_vit/data/datasets/asosenge/derm7pt/release_v0/images'),
    'padufes20':      Path('process_No_Conf_vit/data/datasets/mahdavi1202/skin-cancer'),
    'isic2019':       Path('process_No_Conf_vit/data/datasets/sengenjih/isic2019'),
}
...
def train_epoch(model, loader, optimizer, cfg, epoch, scaler, class_weights, device):
    model.train()
    totals = dict(total=0., cls=0., con=0., mi=0.)
