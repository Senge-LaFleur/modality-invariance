...
All outputs saved in:
    - checkpoints_RESM_resnet18/{clin,derm,both}/
    - results_RESM_resnet18/{clin,derm,both}/
"""
...
# Argument parsing
# ============================================================
parser = argparse.ArgumentParser(description="RESM ResNet-18 — modality ablation")
parser.add_argument(
    '--train_modality',
...
CFG = {
    ...
    'ckpt_dir':       WORK_ROOT / f'checkpoints_RESM_resnet18' / TRAIN_MODALITY,
    'results_dir':    WORK_ROOT / f'results_RESM_resnet18'     / TRAIN_MODALITY,
...
# ============================================================
# Helper: Build train loader with group‑based resampling
# ============================================================
...
def main():
    ...
    train_loader, val_loader, test_loaders, eval_loaders = build_resampled_train_loader(CFG, seed=SEED)
    ...
    plot_training_curves(
        history,
        f"Training History — RESM ResNet-18 [{TRAIN_MODALITY}]",
