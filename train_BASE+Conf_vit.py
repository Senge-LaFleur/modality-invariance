...
IMAGE_ROOTS = {
    'hiba':           Path('process_BASE+Conf_vit/data/datasets/asosenge/hibaskinlesionsdataset-main/HIBASkinLesionsDataset-main/images'),
    'fitzpatrick17k': Path('process_BASE+Conf_vit/data/datasets/asosenge/fitzpatrick17k/fitzpatrick17k/data/finalfitz17k'),
    'derm7pt':        Path('process_BASE+Conf_vit/data/datasets/asosenge/derm7pt/release_v0/images'),
    'padufes20':      Path('process_BASE+Conf_vit/data/datasets/mahdavi1202/skin-cancer'),
    'isic2019':       Path('process_BASE+Conf_vit/data/datasets/sengenjih/isic2019'),
}
