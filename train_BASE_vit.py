...
from models.models_losses import DualViT   # import model only
...
IMAGE_ROOTS = {
    ...
    'padufes20':      Path('process_BASE_vit/data/datasets/mahdavi1202/skin-cancer'),
    'isic2019':       Path('process_BASE_vit/data/datasets/sengenjih/isic2019'),
}
