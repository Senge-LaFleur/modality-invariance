...
All outputs saved in:
    - checkpoints_Modality_Invariance_vit/{clin,derm,both}/
    - results_Modality_Invariance_vit/{clin,derm,both}/
"""
...
# Local definition of ViT layer-wise LR decay
...
# Argument parsing
# ============================================================
parser = argparse.ArgumentParser(description="Modality Invariance ViT — modality ablation")
parser.add_argument(
    '--train_modality',
...
CFG = {
    ...
    'ckpt_dir':      WORK_ROOT / f'checkpoints_Modality_Invariance_vit' / TRAIN_MODALITY,
    'results_dir':   WORK_ROOT / f'results_Modality_Invariance_vit'     / TRAIN_MODALITY,
    ...
    'min_lr': 1e-6,
    'weight_decay': 0.05,
    'warmup_epochs': 3,         # adjust as needed
...
def main():
    ...
    plot_training_curves(history, f"Training History (Modality-Invariant ViT [{TRAIN_MODALITY}])",
                         CFG["results_dir"] / "training_curves.png")

    # t‑SNE on clin test if available
    if 'clin' in test_loaders:
        ...
        plot_tsne(embs, labels_tsne,
                  f"t-SNE — Test [clin] (Modality-Invariant ViT, {TRAIN_MODALITY} trained)",
