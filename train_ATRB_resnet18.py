...
All outputs saved in:
    - checkpoints_ATRB_resnet18/{clin,derm,both}/
    - results_ATRB_resnet18/{clin,derm,both}/
"""
...
# Argument parsing
# ============================================================
parser = argparse.ArgumentParser(description="ATRB ResNet-18 — modality ablation")
parser.add_argument(
    '--train_modality',
...
CFG = {
    ...
    'ckpt_dir':       WORK_ROOT / f'checkpoints_ATRB_resnet18' / TRAIN_MODALITY,
    'results_dir':    WORK_ROOT / f'results_ATRB_resnet18'     / TRAIN_MODALITY,
...
# ============================================================
# Attribute‑aware model (ATRB) that inherits from DualResNet18
# ============================================================
class DualResNet18_ATRB(DualResNet18):
    ...
    Handles all training regimes via super().forward().
    """
    def __init__(self, embed_dim=512, num_classes=5, num_skin_types=6,
                 pretrained=True, use_projection=False, train_modality='both'):
        super().__init__(embed_dim, num_classes, num_skin_types,
                         pretrained, use_projection, train_modality)
    ...
    def forward(self, batch):
        # Get base embeddings and original outputs (handles all regimes)
        base_out = super().forward(batch)
        z = base_out["z"]                     # (B, embed_dim)
...
def main():
    ...
    plot_training_curves(
        history,
        f"Training History — ATRB ResNet-18 [{TRAIN_MODALITY}]",
