...
IMAGE_ROOTS = {
    'hiba':           Path('process_REWT_resnet18/data/datasets/asosenge/hibaskinlesionsdataset-main/HIBASkinLesionsDataset-main/images'),
    'fitzpatrick17k': Path('process_REWT_resnet18/data/datasets/asosenge/fitzpatrick17k/fitzpatrick17k/data/finalfitz17k'),
    'ham10000':       Path('process_REWT_resnet18/data/datasets/asosenge/ham10000/HAM10000'),
    'derm7pt':        Path('process_REWT_resnet18/data/datasets/asosenge/derm7pt/release_v0/images'),
    'padufes20':      Path('process_REWT_resnet18/data/datasets/mahdavi1202/skin-cancer'),              # update path as needed
    'isic2019':       Path('process_REWT_resnet18/data/datasets/sengenjih/isic2019'),                 # update path as needed
}
...
def main():
    ...
    if test_loader:
        ...
        print(f"\n[REWT ResNet-18] Test KNN (k=5) accuracy: {knn_acc:.4f}")
        # ------------------------------------------------
        ...
        # t-SNE plot (existing)
        plot_tsne(embs, labels_tsne, "t-SNE - Test Set (REWT ResNet-18)", CFG["results_dir"] / "tsne_test.png")
