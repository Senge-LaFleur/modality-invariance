...
All outputs saved in:
    - checkpoints_REWT_resnet18/{clin,derm,both}/
    - results_REWT_resnet18/{clin,derm,both}/
"""
...
# Argument parsing
# ============================================================
parser = argparse.ArgumentParser(description="REWT ResNet-18 — modality ablation")
parser.add_argument(
    '--train_modality',
...
CFG = {
    ...
    'ckpt_dir':       WORK_ROOT / f'checkpoints_REWT_resnet18' / TRAIN_MODALITY,
    'results_dir':    WORK_ROOT / f'results_REWT_resnet18'     / TRAIN_MODALITY,
...
def main():
    ...
    plot_training_curves(
        history,
        f"Training History — REWT ResNet-18 [{TRAIN_MODALITY}]",
