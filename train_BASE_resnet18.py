...
IMAGE_ROOTS = {
    ...
    'padufes20':      Path('process_BASE_resnet18/data/datasets/mahdavi1202/skin-cancer'),
    'isic2019':       Path('process_BASE_resnet18/data/datasets/sengenjih/isic2019'),
}
...
CFG = {
    ...
    'ckpt_dir':     WORK_ROOT / 'checkpoints_BASE_resnet18_weighted',
    'results_dir':  WORK_ROOT / 'results_BASE_resnet18_weighted',
