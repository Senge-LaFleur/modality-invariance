...
CFG = {
    ...
    'csv_dir': DRIVE_ROOT / 'csvs',           # where paired_train.csv, clin_train.csv, etc. are stored
    'ckpt_dir': WORK_ROOT / 'checkpoints_modality_resnet18',
    'results_dir': WORK_ROOT / 'results_modality_resnet18',
...
def main():
    ...
    # Optimizer with stage-wise LR decay
    ...
    # (Resume code omitted for brevity – can be added if needed)
