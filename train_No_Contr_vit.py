...
Uses multi-objective losses: Lcls, Lconf, Lskin, LMI. (No Lcon)
...
CFG = {
    ...
    'ckpt_dir':     WORK_ROOT / 'checkpoints_No_Contr_vit',
    'results_dir':  WORK_ROOT / 'results_No_Contr_vit',
...
def train_epoch(model, loader, optimizer, cfg, epoch, scaler, class_weights, device):
    model.train()
    totals = dict(total=0., cls=0., conf=0., skin=0., mi=0.)
