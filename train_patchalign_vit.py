...
CFG = {
    ...
    'vit_model': 'vit_small_patch16_224', 'embed_dim': 384, 'img_size': 224,
    'num_classes': 5, 'num_skin_types': 6, 'num_text_labels': 6,
    'text_embed_dim': 768,
    'batch_size': 32, 'num_epochs': 20, 'lr': 3e-5, 'min_lr': 1e-6,
    'weight_decay': 0.05, 'warmup_epochs': 4, 'aug_probability': 0.85,
...
class ProjectionHead(nn.Module):
    def __init__(self, in_dim, hidden_dim=1024, out_dim=384):
        super().__init__()
...
class PatchAlignViT(nn.Module):
    def __init__(self, embed_dim=384, num_classes=5, num_skin_types=6,
                 num_text_labels=6, text_embed_dim=768, pretrained=True,
                 use_projection=False, vit_model_name="vit_small_patch16_224"):
        super().__init__()
...
def main():
    ...
    plot_training_curves(history, "Training History (PatchAlign ViT)", CFG["results_dir"]/"training_curves.png")
    ...
    if test_loader:
        ...
        plot_tsne(embs, labels_tsne, "t-SNE - Test Set (PatchAlign ViT)", CFG["results_dir"]/"tsne_test.png")
