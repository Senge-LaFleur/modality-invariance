...
IMAGE_ROOTS = {
    ...
    'padufes20':      Path('process_Modality_Invariance_resnet18/data/datasets/mahdavi1202/skin-cancer'),
    'isic2019':       Path('process_Modality_Invariance_resnet18/data/datasets/sengenjih/isic2019'),
}
