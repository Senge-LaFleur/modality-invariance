...
IMAGE_ROOTS = {
    'hiba':           Path('process_Modality_Invariance_resnet18/data/datasets/asosenge/hibaskinlesionsdataset-main/HIBASkinLesionsDataset-main/images'),
    'fitzpatrick17k': Path('process_Modality_Invariance_resnet18/data/datasets/asosenge/fitzpatrick17k/fitzpatrick17k/data/finalfitz17k'),
    'ham10000':       Path('process_Modality_Invariance_resnet18/data/datasets/asosenge/ham10000/HAM10000'),
    'derm7pt':        Path('process_Modality_Invariance_resnet18/data/datasets/asosenge/derm7pt/release_v0/images'),
    'padufes20':      Path('process_Modality_Invariance_resnet18/data/datasets/mahdavi1202/skin-cancer'),              # update path as needed
    'isic2019':       Path('process_Modality_Invariance_resnet18/data/datasets/sengenjih/isic2019'),                 # update path as needed
}
